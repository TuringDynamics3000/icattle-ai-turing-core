      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-24 relative">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="font-serif font-light text-6xl md:text-7xl mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/">
                <a className="inline-flex items-center gap-2 px-8 py-4 bg-mauve-600 text-white rounded-full font-medium hover:bg-mauve-700 transition-all shadow-soft-lg hover:shadow-soft-xl">
                  View Dashboard
              ...
              <Link href="/golden-record">
                <a className="inline-flex items-center gap-2 px-8 py-4 bg-white text-mauve-600 rounded-full font-medium hover:bg-lavender-50 transition-all shadow-soft-md border border-mauve-200">
      ...
      <section className="py-24 bg-lavender-50">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="font-serif font-light text-5xl mb-6 text-gray-900">
...
function FeatureCard({ title, description, icon, href }: {
  ...
  return (
    <Link href={href}>
      <a className="block bg-white rounded-2xl p-8 shadow-soft-md hover:shadow-soft-lg transition-all">
