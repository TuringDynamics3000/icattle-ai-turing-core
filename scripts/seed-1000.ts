 ...
 * ==========================================
 * Generates 1,000 cattle records with realistic geographic distribution
 * 
...
async function seed() {
  ...
  try {
    ...
    for (const region of AUSTRALIAN_BEEF_REGIONS) {
      const cattleInRegion = Math.round(1000 * (region.cattlePercentage / 100));
    ...
    // Generate 1000 cattle in batches
    console.log('🐄 Generating 1,000 cattle records...\n');
    
    const BATCH_SIZE = 1000;
    const TOTAL_CATTLE = 1000;
    ...
    console.log(`\n✅ Generated 1,000 cattle in ${totalMinutes} minutes`);
